...
public:
	...
	*/
	...
	void setCullBack(bool b); // Set the cull mode to back/front
	bool getCullMode(); // Return the cull mode

	void setCullOn(bool b); // Set cull mode on/off
...
protected:
	...
	bool cullModeState; // Variable tracks cull mode state
	bool cullOn;
	...
	ID3D11RasterizerState* rasterStateCFront;			///< Default FILL raster state
	ID3D11RasterizerState* rasterStateWF;		///< Wireframe raster state
	ID3D11RasterizerState* rasterStateCBack;		///< Wireframe raster state
	ID3D11RasterizerState* rasterStateCOff;		///< Wireframe raster state

...
{
	// Check if the direction is zero, and set it to a default value
	if (XMVector3Equal(XMLoadFloat3(&direction), XMVectorZero())) {
		direction = XMFLOAT3(0.0f, 0.0f, 1.0f); // Default direction
	}
